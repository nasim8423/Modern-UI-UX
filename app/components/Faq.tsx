...
const Faq = () => {
  return (
    <div className="w-full flex flex-col py-[40px] lg:py-[60px] lg:flex-row lg:gap-x-7">
      <div className="lg:w-1/3 lg:py-[32px] lg:pr-[56px] ">
        <h3 className="text-[#EB2891] text-[14px] font-medium lg:text-base">
          Frequently Asked Questions
        </h3>
        <h1 className="text-2xl leading-[32px] py-3 font-medium text-[#172026] lg:text-[42px] lg:leading-[50px]">
          Lets clarify some of your questions
        </h1>
        <p className="text-[#36485C] font-[400] text-[16px] mb-[24px]">
                ...
                >
                    <Accordion.Header>
                        <Accordion.Trigger className="w-full flex items-center justify-between">
                            ...
                            <span><Image src={Plus} alt="plus-icon" className="h-10 w-10 lg:w-6 lg:h-6"/></span>
                        </Accordion.Trigger>
                    </Accordion.Header>
